...
SECRET_KEY = 'django-insecure-0jd+z+t-16&j3c$-_ew0d0tz+jo2*58#n13r9cqo8o8l3lp&mn'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=60),  # Увеличьте время жизни токена доступа
...
DATABASES = {
    'default': {
        ...
        'NAME': 'fishing_reports_db',  # имя базы данных
        'USER': 'fishing_user',        # имя пользователя
        'PASSWORD': 'strongpassword',  # пароль пользователя
        'HOST': 'db',           # если база данных на той же машине
